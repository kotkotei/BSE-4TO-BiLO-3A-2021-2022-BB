...
namespace WindowsFormsApp21
{
    public class Fraction
    {
        ...
        public static Fraction Parse(string str)
        {
            ...
            int k = str.IndexOf("(");
            string s2 = str.Substring(0, k);
            f.integer = Convert.ToInt32(s2);
            if (f.integer < 0)
            {
                f.sign = -1;
                f.integer = -f.integer;
            ...
            int k2 = str.IndexOf(")");
            s2 = str.Substring(k + 1, k2 - k - 1);
            int k3 = s2.IndexOf("/");
            f.numerator = Convert.ToInt32(s2.Substring(0, k3));
            f.denominator = Convert.ToInt32(s2.Substring(k3+1,s2.Length-k3-1));
            return f;
        }
