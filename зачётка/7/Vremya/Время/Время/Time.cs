...
namespace Время
{
    public class Data
    {
        ...
        public Data (double n_SAJEN, double n_ARHIN, double n_VERHOK, double n_p, double n_VERSTA)
        {
            SAJEN = n_SAJEN;
            ARHIN = n_ARHIN;
            VERHOK = n_VERHOK;
        ...
        public Data(int saJEN, int aRHIN, int vERHOK)
        {
            SAJEN = saJEN;
            ARHIN = aRHIN;
            VERHOK = vERHOK;
        ...
        public Data(int saJEN, int aRHIN, int vERHOK, int vERSTA) : this(saJEN, aRHIN, vERHOK)
        {
        }
