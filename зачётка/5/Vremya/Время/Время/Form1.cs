...
namespace Время
{
    public partial class Form1 : Form
    {
        ...
        public Data ReceiveF()
        {
            ...
            Data newf= new Data(hour, days, years);
            return newf;
        ...
        public Data ReceiveF2()
        {
            ...
            int days2 = Convert.ToInt32(textBox5.Text);
            int years2 = Convert.ToInt32(textBox6.Text);

            Data newf2= new Data(hour2, days2, years2);
            return newf2;
        }
        ...
        private void Print(Data f)
        {
            ...
            textBox8.Text = f.days.ToString();
            textBox7.Text = f.years.ToString();
        }
